...
public enum Kind {
  ...
  SCALA_ANNEX_BINARY("annex_scala_binary", LanguageClass.SCALA, RuleType.BINARY),
  SCALA_ANNEX_LIBRARY("annex_scala_library", LanguageClass.SCALA, RuleType.LIBRARY),
  SCALA_ANNEX_TEST("annex_scala_test", LanguageClass.SCALA, RuleType.TEST),
